...
<div className="flex flex-col items-center mt-6 ">
    ...
    <div className="flex justify-center my-10">
        <a href="#" className='bg-gradient-to-r from-orange-500 to-orange-800 py-3 px-4 mx-3 rounded-md hover:scale-105'>Start for free</a>
        <a href="#" className='py-3 px-4 rounded-md border hover:scale-105'>Documentation</a>
    </div>
